...
if (
  ...
  fetch(`${BACK_URLROOT}Produits/getProduitById_User/${ID_USER}`, {
    method: "GET",
    headers: {
  ...
  searchByIDInput.addEventListener("input", () => {
    ...
    if (isNaN(valueInput)) {
      ...
      fetch(`${BACK_URLROOT}Produits/SearchProduitsById/${valueInput}/${ID_USER}`,{
          method: "GET",
          headers: {
            "Content-Type": "application/json"
          }
        ...
        .then(data => {
          if (data.message == "Produit Isset") {
            tr = `<tr id="tr${data.result.id_produit}">
                        ...
                        <td>
                          <span class="btnActionUser">
                            <i class ="fa fa-edit" aria-hidden="true" onclick="editProduit(${data.result.id_produit})"></i>
                            <i class ="fa fa-close" onclick="deleteProduit(${data.result.id_produit})"></i>
                          </span>
                        </td>
                      </tr>`;
            tbodyTrs.innerHTML = tr;
  ...
  searchInput.addEventListener("input", () => {
    ...
    fetch(`${BACK_URLROOT}Produits/SearchProduits/${valueInput}/${ID_USER}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json"
