        ...
        <div class="row justify-content-center">
            <div class="col-md-12 col-lg-10">
                <div class="wrap d-md-flex">
                    <div class="img" style="background-image: url(<?= URLROOT ?>layout/image/bg-3.jpg);">
                    </div>
                    <div class="login-wrap p-4 p-md-5" id="changeForm">
                    <div class="d-flex">
                            <div class="w-100">
                                <h3 class="mb-4" id="click" onclick="SignIn()">Sign In Fournisseur</h3>
                            </div>
                            <div class="w-100">
...
<script src=" <?=URLROOT?>/layout/js/formFournisseur.js"></script>